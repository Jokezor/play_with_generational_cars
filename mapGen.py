...
def generateRandomMap(screen):
    ...
    while True:
        ...
        if len(maze.find_valid_neighbours(currentCell)) > 0:
            if (
                currentCell.x == 0 and currentCell.y == 3
                ...
                trackLenght += (
                    1  # Keep track of length so to discard very short generated tracks
                )
            else:
                random_unvisited_direction = random.choice(
                    maze.find_valid_neighbours(currentCell)
                )[
                    0
                ]  # Pick a random direction to move
                oldCell = currentCell
                if (
                    random_unvisited_direction == "N"
                ):  # Move according to the direction picked
                    currentCell = maze.cell_at(oldCell.x, oldCell.y - 1)
            ...
            if currentCell.x == 0 and currentCell.y == 4 and trackLenght > 40:
                ...
                for x in range(0, WINDOW_WIDTH, blockSize):
                    for y in range(0, WINDOW_HEIGHT, blockSize):
                        currentCell = maze.cell_at(
                            int(x / blockSize), int(y / blockSize)
                        )
                ...
                for x in range(0, WINDOW_WIDTH, blockSize):
                    for y in range(0, WINDOW_HEIGHT, blockSize):
                        ...
                        if (
                            ...
                            and currentCell.walls["S"] == False
                        ):
                            SCREEN.blit(
                                straight2, straight2Rect.move(x + movex, y + movey)
                            )
                        elif (
                            currentCell.walls["E"] == False
                            and currentCell.walls["W"] == False
                        ):
                            SCREEN.blit(
                                straight1, straight1Rect.move(x + movex, y + movey)
                            )
                        elif (
                            currentCell.walls["N"] == False
                            and currentCell.walls["W"] == False
                            ...
                            and currentCell.walls["E"] == False
                        ):
                            SCREEN.blit(curve1, curve1Rect.move(x + movex, y + movey))
                        elif (
                            currentCell.walls["E"] == False
                            and currentCell.walls["N"] == False
                        ):
                ...
                for y in range(img.size[1]):
                    for x in range(img.size[0]):
                        if pixdata[x, y] == (0, 0, 0, 255) or pixdata[x, y] == (
                            0,
                            0,
                            1,
                            255,
                ...
                for x in range(0, WINDOW_WIDTH, blockSize):
                    for y in range(0, WINDOW_HEIGHT, blockSize):
                        ...
                        if (
                            ...
                            SCREEN.blit(
                                straight2Top,
                                straight2RectTop.move(x - 20 + movex, y + movey),
                            )
                        elif (
                            currentCell.walls["E"] == False
                            and currentCell.walls["W"] == False
                            ...
                            SCREEN.blit(
                                straight1Top,
                                straight1RectTop.move(x + movex, y - 20 + movey),
                            )
                        elif (
                            currentCell.walls["N"] == False
                            and currentCell.walls["W"] == False
                            ...
                            SCREEN.blit(
                                curve3Top,
                                curve3RectTop.move(x - 15 + movex, y - 15 + movey),
                            )
                        elif (
                            currentCell.walls["W"] == False
                            and currentCell.walls["S"] == False
                            ...
                            SCREEN.blit(
                                curve2Top,
                                curve2RectTop.move(x - 15 + movex, y - 15 + movey),
                            )
                        elif (
                            currentCell.walls["E"] == False
                            and currentCell.walls["N"] == False
                            ...
                            SCREEN.blit(
                                curve4Top,
                                curve4RectTop.move(x - 15 + movex, y - 15 + movey),
                            )
                        elif (
                            currentCell.walls["S"] == False
                            and currentCell.walls["E"] == False
                            ...
                            SCREEN.blit(
                                curve1Top,
                                curve1RectTop.move(x - 15 + movex, y - 15 + movey),
                            )
                ...
                for x in range(0, WINDOW_WIDTH, blockSize):
                    for y in range(0, WINDOW_HEIGHT, blockSize):
                        maze.cell_at(int(x / blockSize), int(y / blockSize)).walls[
                            "N"
                        ] = True
                        maze.cell_at(int(x / blockSize), int(y / blockSize)).walls[
                            "S"
                        ...
                        maze.cell_at(int(x / blockSize), int(y / blockSize)).color = (
                            0,
                            0,
                            0,
                        )
