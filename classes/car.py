...
from constants.colors import white, Color_line
...
class Car:
    ...
    def update(
        self,
    ):  # En cada frame actualizo los vertices (traslacion y rotacion) y los puntos de colision
